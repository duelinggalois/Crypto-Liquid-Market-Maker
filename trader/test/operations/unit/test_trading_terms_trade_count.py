...
class test_skew(unittest.TestCase):
  ...
  def test_find_count_A(self):
    count_A = TradingTerms.find_count(self.minimum_size_A, self.size_change_A,
  ...
  def test_find_count_B(self):
    count_B = TradingTerms.find_count(self.minimum_size_B, self.size_change_B,
  ...
  def test_find_count_C(self):
    count_C = TradingTerms.find_count(self.minimum_size_C, self.size_change_C,
  ...
  def test_find_count_D(self):
    count_D = TradingTerms.find_count(self.minimum_size_D, self.size_change_D,
